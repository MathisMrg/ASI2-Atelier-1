...
public class CardGeneratorService {
    ...
    public CardGeneratorService(TransactionService transactionService, JmsTemplate jmsTemplate, @Lazy CardModelService cardModelService, FileService fileService) {
